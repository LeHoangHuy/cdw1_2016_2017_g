...
<html style="background-color: #f3f3f4;">
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/type-l-1.less', 'css/type-l-1.css');
        ?>
        <link href="css/type-l-1.css" rel="stylesheet" type="text/css" />
                                ...
                                <div class="lms_newsletter">
                                    ...
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="lms_newsletter_widget_btn">OK</button>
                                        </div>
                                    </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="lms_footer_contact">
                                    <h3>Contacts</h3>
                                    <p>Lorem ipit amet, consectetur adipiscing elit.
