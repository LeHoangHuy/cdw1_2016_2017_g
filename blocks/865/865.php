...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/865.less', 'css/865.css');
        $less->compileFile('less/swipe-slider.less', 'css/swipe-slider.css');
        $less->compileFile('less/865-slider.less', 'css/865-slider.css');
        ?>
        <link rel="stylesheet" href="css/bootstrap.min.css">
        <link rel="stylesheet" href="css/font-awesome.min.css">

        <link rel="stylesheet" href="css/865.css">   
        <link rel="stylesheet" href="css/swipe-slider.css">   
        <link rel="stylesheet" href="css/865-slider.css">
            ...
            <div id="pattent" class="slidelip white-background">  
                <div class="container container-modify margin-auto header">
                    ...
                    <div id="zaro-carousel" class="margin-auto">
                        ...
                        <div id="homepage_carousel" class="swiper-container">
                ...
                <script>
                    jQuery(document).ready(function ($) {
                        var homepage_carousel = new Swiper('#homepage_carousel', {
                            loop: true,
                            speed: 500,
                            slidesPerView: 5,
                            spaceBetween: 0,
